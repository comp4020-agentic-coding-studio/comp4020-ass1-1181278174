...
It worked on the tiny 12-node test graph; on the real 60×40 field it never did.
...
switch either. I changed the claim to what every experiment supported.
...
differences and decided each. The fastest way to make the ants
...
A random-turn probability, a shortcut-door mechanic, two claims, four maze layouts.
